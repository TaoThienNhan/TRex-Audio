    ...
    <div class="container-fluid py-3 bg-dark">
        <div class="container">
            <div class="title mb-3">
                <h2 class="text-center py-3 fw-bolder" style="background: url(<?= get_stylesheet_directory_uri(); ?>/assets/src/images/background-gold.png);">SẢN PHẨM BÁN CHẠY</h2>
            </div>
            <div class="row g-4">
                        ...
                        <div class="product-single-container p-2 border border-secondary">
                            <div class="product-single">
                                ...
                                <div class="row product-single-footer d-flex align-items-center p-3 mx-0">
                                    <div class="left-product-single-footer col-lg-7 d-flex flex-column  align-items-center d-lg-block ">
                                        <a href="#" class="text-white mb-0 product-name"><strong>Loa Bluetooth Soundmax B-60/5.1</strong></a>
                                        <div class="rate">
                                    ...
                                    <div class="right-product-single-footer col-lg-5 d-flex justify-content-center justify-content-lg-end ">
                                        <a href=" " class="text-white text-center px-3 py-4 border-white border detail-text"><h6 class="m-0">CHI TIẾT</h6></a>
                                    </div>
                                </div>
                            </div>
                        </div>
