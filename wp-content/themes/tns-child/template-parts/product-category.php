    ...
    <div class="container-fluid py-3 bg-dark">
        <div class="container">
            <div class="row py-3">
                ...
                <h2 class="text-center py-3 m-0" style="background: url(<?= get_stylesheet_directory_uri(); ?>/assets/src/images/background-gold.png);background-position: center;font-size: 16px;font-weight: 800;">LOA</h2>
                </div>
